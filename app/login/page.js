...
const Login = () => {
  ...
  useEffect(() => {
    document.title = "Login - Fund Start"
    if (session) {
    ...
    <>
      ...
      <div className="social_login_buttons">
        <div className="flex flex-col gap-2 justify-center items-center p-10">
          <button className="flex items-center justify-center w-[400px] border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-black bg-slate-50 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 ">
            <svg
